...
@WebMvcTest(controllers = {SpringWebController.class, LoginController.class, SurveyorController.class, QuestionController.class, AnswerController.class, ResultsController.class})
...
public class ResultControllerTest {
    ...
    public void testRangeResultsPage() throws Exception {
        ...
        mockMvc.perform(post("/surveyorIndex/createQuestion")
                        ...
                        .param("max", "10"))
                .andDo(print()).andExpect(status().isFound());
        mockMvc.perform(get("/surveyorIndex/Result")).andDo(print()).andExpect(status().isFound());
